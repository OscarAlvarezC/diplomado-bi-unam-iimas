...
- [**`ejemplo_proyecto_final/`**](ejemplo_proyecto_final/README.md) — Proyecto completo de referencia sobre la calidad del aire en CDMX (SIMAT 2023). Incluye informe en `README.md`, esquema estrella en SQL, ETL Python end-to-end con validaciones, queries con SQL avanzado (CTE + window functions + `COUNT FILTER` + `PERCENTILE_CONT`), y dashboard Streamlit con 4 vistas. Cumple los 7 criterios de la rúbrica a nivel ~Excelente.
