...
1. Script `etl_pipeline.py` ejecutable.
2. Cuaderno (`.sql` o `.ipynb`) con las queries analíticas requeridas.
3. Reporte descriptivo (1-2 páginas).
4. Presentación de 5-10 minutos.
